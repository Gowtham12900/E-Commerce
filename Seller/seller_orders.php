...
<nav class="navbar navbar-dark" style="background-color: #008000;">
  <div class="container-fluid">
    ...
    <a class="navbar-brand text-light" href="#"><b>Orders Management</b></a>
  </div>
</nav>
...
<div class="offcanvas offcanvas-start custom-sidebar" tabindex="-1" id="sidebar">
  ...
  <div class="offcanvas-body">
    <ul class="nav flex-column">
      <li class="nav-item"><a class="nav-link text-dark" href="seller.php"><i class="bi bi-box-fill me-2"></i><b>Products</b></a></li>
      <li class="nav-item"><a class="nav-link text-dark active" href="seller_orders.php"><i class="bi bi-clipboard-check-fill me-2"></i><b>Orders</b></a></li>
      <li class="nav-item"><a class="nav-link text-dark" href="logout.php"><i class="bi bi-box-arrow-right me-2"></i><b>Logout</b></a></li>
    </ul>
  </div>
</div>

<div class="container mt-5">
  <h3 class="mb-4"><b>Your Orders</b></h3>
  ...
  if (!$result) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
      echo "<tr>
              ...
              <td>
                <form action='seller_updates.php' method='POST'>
